...
- **요금(VAT 별도)**: ① CatchLog 로그분석 — 월 PV 구간제 10만 17,500 / 20만 24,000 / 30만 30,500 / 40만 37,000, 40만 초과 10만 PV당 +6,500, 14일 무료체험(자동결제 없음), 연간 요금 없음(연간 선택 시 월×12) ② 자동리포트 월 70,000 / 연 700,000 ③ 자동 ROAS 최적화(AUTO BID) 월 100,000 / 연 1,000,000.
