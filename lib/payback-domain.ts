...
const KR_HOLIDAYS = new Set<string>([
  ...
  // 2028
  "2028-01-01",
  "2028-01-26", "2028-01-27", "2028-01-28", // 설
  "2028-03-01",
  "2028-04-12", // 국회의원 선거
  "2028-05-02", // 석가탄신일
  "2028-05-05",
  "2028-06-06",
  "2028-08-15",
  "2028-10-02", "2028-10-03", "2028-10-04", "2028-10-05", // 추석 + 개천절 중복 대체
  "2028-10-09",
  "2028-12-25",
]);

// 공휴일 테이블이 커버하는 마지막 연도 (연말 갱신 체크용)
export const KR_HOLIDAYS_LAST_YEAR = 2028;
