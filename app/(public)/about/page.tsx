    ...
    <div>
      ...
      <section className="bg-secondary text-secondary-foreground">
        <div className="mx-auto max-w-4xl px-6 py-20 text-center">
          ...
          <h1 className="mt-4 text-2xl font-extrabold leading-snug md:text-4xl">
      ...
      <section className="mx-auto max-w-3xl px-6 py-16">
        <h2 className="text-center text-xl font-extrabold text-secondary md:text-2xl">
          문제 인식
        </h2>
        ...
        <p className="mt-12 text-center text-base font-bold leading-relaxed text-primary md:text-lg">
        ...
        <div className="mx-auto max-w-3xl px-6">
          ...
          <ul className="mt-8 grid gap-3 sm:grid-cols-2">
            {FOCUS.map((f) => (
              <li
                key={f}
                className="flex items-start gap-2 rounded-xl border bg-card p-4 text-sm text-foreground shadow-sm"
              >
      ...
      <section className="mx-auto max-w-3xl px-6 py-16 text-center">
        ...
        <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
          ...
          집중할 수 있도록 돕습니다. 합리적인 구조 위에서, 좋은 마케팅이 작동하도록
          만드는 것. 그것이 팀퍼스트의 역할입니다.
        </p>

        <div className="mt-10 rounded-2xl border bg-muted/40 p-6 text-left text-sm text-muted-foreground">
